...
- 🤖 **AI 智能赋能**：集成 DeepSeek 大模型与规则引擎双路由，提供财务智能分析与还礼测算。
...
| **`alex_finance`**   | **财务核算中心**：礼尚往来人情记账、预付卡、账单流水及对账。     |
| **`alex_oss`**       | **对象存储服务**：统一封装 MinIO/阿里云 OSS，管理静态资源。      |
| **`alex_ai`**        | **智能分析中心**：DeepSeek 大模型与规则引擎双路由分析。           |
...
3.  **服务顺序启动**：
    ...
    - 其他业务模块（如 `product`, `finance`, `oss`, `ai` 等）
