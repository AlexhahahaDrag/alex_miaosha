...
public class OrgUserInfoController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(value = "查询条件", name = "orgUserInfoVo", dataTypeClass = OrgUserInfoVo.class)}
    )
    ...
    @LogRestRequest(apiName = "删除用户公司信息表")
    @ApiOperationSupport(order = 50, author = "majf")
    @ApiOperation(value = "删除用户公司信息表", notes = "删除用户公司信息表", response = Result.class)
    @DeleteMapping
