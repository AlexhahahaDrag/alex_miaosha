...
public class PermissionInfoController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(value = "查询条件", name = "permissionInfoVo", dataTypeClass = PermissionInfoVo.class)}
    )
    ...
    @LogRestRequest(apiName = "删除权限信息表")
    @ApiOperationSupport(order = 50, author = "majf")
    @ApiOperation(value = "删除权限信息表", notes = "删除权限信息表", response = Result.class)
    @DeleteMapping
