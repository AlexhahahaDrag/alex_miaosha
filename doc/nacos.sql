...
INSERT INTO `his_config_info` VALUES (5, 13, 'nacos-service.yaml', 'alex-miaosha', '', 'spring:\r\n    cloud:\r\n        nacos:\r\n        discovery:\r\n            server-addr: ${nacos.url}\r\n            group: ${nacos.group}\r\n            namespace: ${nacos.namaspace}\r\n        server-addr: ${nacos.url}', '8c2ea29ef4b948c3af107adf6149a252', '2022-11-10 16:00:28', '2022-11-10 08:00:29', 'nacos', '0:0:0:0:0:0:0:1', 'U', '033377eb-973b-4dac-a0e9-e99c87325009', '');
INSERT INTO `his_config_info` VALUES (5, 14, 'nacos-service.yaml', 'alex-miaosha', '', 'spring:\n    cloud:\n        nacos:\n            discovery:\n                server-addr: ${nacos.url}\n                group: ${nacos.group}\n                namespace: ${nacos.namaspace}\n            server-addr: ${nacos.url}', 'daaffab6ed8630f5f1195be2ded3e583', '2022-11-10 09:19:23', '2022-11-10 09:19:24', 'nacos', '0:0:0:0:0:0:0:1', 'U', '033377eb-973b-4dac-a0e9-e99c87325009', '');
