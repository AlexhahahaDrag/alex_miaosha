package com.alex.finance.cpnCouponInfo.entity;
...
@TableName("cpn_coupon_info_t")
@ApiModel(value = "CpnCouponInfo对象", description = "消费券信息表")
public class CpnCouponInfo extends BaseEntity<CpnCouponInfo>{
